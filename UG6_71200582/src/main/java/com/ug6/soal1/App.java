...
public class App {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        if (choice.equalsIgnoreCase("y")) {
            ...
            phone = new Phones(getPhoneName(), getPhoneCode(), getAndroidCode());
            conductProductionMenu();
        }
    ...
    private static void addPhoneSpecification() {
        ...
        phone = new Phones(getPhoneCode(), getAndroidCode(), getRamCapacity(), getRomCapacity(), getCameraResolution(), getScreenSize(),getPhoneName());
    }
