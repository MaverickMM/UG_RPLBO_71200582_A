        ...
        switch(pilihan) {
            ...
            case 6:
                if (pohon.getMusim() == null) {
                    ...
                    System.out.println("Sekarang adalah Musim " + pohon.getMusim().getName() + " dan pohon kamu sedang musim buah " + pohon.getBuah().getName());
                }
    ...
    private static void panenBuah(Pohon pohon) {
        if (pohon.getMusim() != null) {
            ...
            if (selisihHari <= 1L && selisihHari > -1L) {
                System.out.println("Pohon kamu akan berbuah " + pohon.getBuah().getName() + "setiap hari dan kamu dapat memetik buah tersebut dalam " + pohon.getBuah().getLamaBertahan() + " hari sebelum buah " + pohon.getBuah().getName() + " busuk");
            } else if (selisihHari > 1L) {
                System.out.println("Pohon kamu akan berbuah " + pohon.getBuah().getName() + " setiap " + pohon.getBuah().getMasaPanen() + " hari dan kamu dapat memetik buah tersebut dalam " + pohon.getBuah().getLamaBertahan() + " hari sebelum buah " + pohon.getBuah().getName() + " busuk");
            }
